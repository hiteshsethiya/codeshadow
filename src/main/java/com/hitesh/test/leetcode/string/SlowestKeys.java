...
public class SlowestKeys {
     ...
     * testing sequence, and a sorted list releaseTimes, where releaseTimes[i] was the time the ith key was released.
     ...
     * The ith keypress had a duration of releaseTimes[i] - releaseTimes[i - 1], and the 0th keypress
    ...
    public char slowestKey(int[] releaseTimes, String keysPressed) {
        ...
        int start = 0, max = 0;
        for(int i = 0; i < n; ++i) {
            if(max < (releaseTimes[i] - start)) {
                o = keysPressed.charAt(i);
                max = releaseTimes[i] - start;
            } else if(max == (releaseTimes[i] - start) && o - 'a' <= keysPressed.charAt(i) - 'a') {
                o = keysPressed.charAt(i);
            }
